...
const details = [
  { icon: MapPin, label: "Location", value: "412 Forge Street, Downtown District" },
  { icon: Phone, label: "Phone", value: "(555) 018-2940" },
  { icon: Mail, label: "Email", value: "join@ironpulse.fit" },
  { icon: Clock, label: "Staffed Hours", value: "Mon–Fri 6am–10pm · Weekends 8am–8pm" },
]
