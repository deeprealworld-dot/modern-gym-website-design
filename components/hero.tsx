      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-6 font-heading text-5xl font-bold uppercase leading-[0.95] tracking-tight text-balance sm:text-7xl lg:text-8xl">
            Forge a body that <span className="text-primary">won&apos;t quit</span>
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground text-pretty">
            IRONPULSE is more than a gym. It&apos;s a 24/7 strength and conditioning facility built
            for people who are done settling. Elite coaching, serious equipment, real results.
          </p>
